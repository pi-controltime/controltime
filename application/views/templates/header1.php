...
<head lang ="es">
    ...
    <title>Registro Horas Banco de Alimentos</title>
  	    ...
  	    <div class="mdl-layout__header-row">
  	      ...
  	      <div class="android-navigation-container">
  	        <nav class="android-navigation mdl-navigation">
  	          <a class="mdl-navigation__link mdl-typography--text-uppercase" href="<?php echo base_url(); ?>index.php/login">CERRAR SESION</a>
  	        </nav>
  	      </div>
...
<!--  	  
      <div class="android-drawer mdl-layout__drawer">
        <nav class="mdl-navigation">
          <a class="mdl-navigation__link" href="">EPS</a>
          <a class="mdl-navigation__link" href="">INSTITUCIONES</a>
          <a class="mdl-navigation__link" href="">REGISTRO</a>
